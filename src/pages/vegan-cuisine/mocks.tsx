...
export const VEGAN_RECIPES = [
    ...
    },
    {
        ...
        steps: [
            { stepNumber: 1, description: 'Отварить картошку и сделать пюре.', image: 'url' },
            { stepNumber: 2, description: 'Обжарить грибы до готовности.', image: 'url' },
            {
                stepNumber: 3,
    ...
    },
    {
        ...
        steps: [
            ...
            { stepNumber: 2, description: 'Сложить слои лазаньи.', image: '/img/cook-steps/2.jpg' },
            { stepNumber: 3, description: 'Запекать 30 минут.', image: '/img/cook-steps/3.jpg' },
        ],
    },
    {
        id: '3',
        ...
        steps: [
            ...
            { stepNumber: 3, description: 'Подавать с соусом.', image: 'url' },
        ],
    },
    {
        id: '4',
        ...
        steps: [
            ...
            { stepNumber: 2, description: 'Обжарить с чесноком.', image: 'url' },
            { stepNumber: 3, description: 'Подавать горячей.', image: '/img/cook-steps/3.jpg' },
        ],
        side: 'potatoes',
    },
    {
    ...
    },
    {
        ...
        steps: [
            { stepNumber: 1, description: 'Нарезать все овощи.', image: '/img/cook-steps/1.jpg' },
            { stepNumber: 2, description: 'Обжарить на сковороде.', image: 'url' },
            {
                stepNumber: 3,
